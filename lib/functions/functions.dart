...
// import 'package:location/location.dart';
import 'package:herodriver/pages/NavigatorPages/editprofile.dart';
import 'package:herodriver/pages/NavigatorPages/history.dart';
import 'package:herodriver/pages/NavigatorPages/makecomplaint.dart';
import 'package:herodriver/pages/loadingPage/loadingpage.dart';
import 'package:herodriver/pages/login/get_started.dart';
import 'package:herodriver/pages/login/login.dart';
import 'package:herodriver/pages/onTripPage/droplocation.dart';
import 'package:herodriver/pages/onTripPage/invoice.dart';
// import 'package:herodriver/pages/login/ownerregister.dart';
import 'package:herodriver/pages/onTripPage/map_page.dart';
import 'package:herodriver/pages/onTripPage/review_page.dart';
import 'package:herodriver/pages/vehicleInformations/referral_code.dart';
import 'package:herodriver/pages/vehicleInformations/service_area.dart';
...
import 'package:herodriver/pages/vehicleInformations/vehicle_type.dart';
        ...
        if (userDetails['onTripRequest'] != null) {
         ...
         //   waitingAfterStart();
          ...
          if (duration == 0 || duration == 0.0) {
            if (isBackground == true && platform == Platform.isAndroid) {
...
audioPlay() async {
   audioPlayer.load('audio/request_sound.mp3');
}
...
geolocs.LocationSettings locationSettings = (platform == Platform.isAndroid)
